...
export const metadata: Metadata = {
  metadataBase: new URL("https://larrythe25thdev.netlify.app/"),
  alternates: {
    canonical: "/",
  },
  title: {
  ...
  description: "Still learning, Still growing, Full Stack Engineer, & Barista.",
};
...
function Footer() {
  const links = [
    { name: "@larrythe25thdev", url: "https://x.com/" },
