      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-semibold">Next Developer Kit</span>
            </Link>
            <p className="text-sm text-gray-600 dark:text-gray-400 max-w-sm">
              Launch your SaaS in minutes with our production-ready Next.js
              Developer kit. Everything you need, from auth to payments.
            </p>
            <div className="flex space-x-4">
              <Link href="https://github.com/LarryPursuit" target="_blank">
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
          <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Next Developer Kit. All rights
            reserved.
          </p>
        </div>
      </div>
